...
const basePath = scriptElement
  ...
  : "/local/ha-controls/universal-select-card/";
...
["universal-select-card.css"].forEach(loadCSS);
["universal-select-card.js", "universal-select-card-editor.js"].forEach(loadJS);
