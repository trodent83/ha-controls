      ...
      this.dispatchEvent(new CustomEvent("show-grid-popup", {
        detail: {
          ...
          body: {
            ...
            entities: (this.config.entities || []).filter(e => {
              const entityId = typeof e === 'object' ? e.entity : e;
              return !this._disabledCalendars.has(entityId);
            }),
            start_date: dateStr,
            max_days: 1,
      ...
      case "description": {
        ...
        return html`
          <div class="dialog-feature-row feature-description">
            ...
            <div class="feature-content markdown-body">${parseHtml(description)}</div>
          </div>
        `;
      }
